            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <form action="write">
                            <input type="text" class="form-control" id="basicInput" placeholder="제목을 작성해 주세요." width="300">
                        </div>
                        <div class="form-group with-title mb-3">
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" placeholder="글 내용을 작성해 주세요."></textarea>
                            <label>글 내용</label>
                        </div>
